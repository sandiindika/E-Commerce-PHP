        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="riwayat.php" title="Riwayat Transaksi"><span class="glyphicon glyphicon-list-alt"></span></a></li>
                </ul>
...
?>
    <div class="page-header">
        <h1>Barang Sudah Sampai<small> <?php echo "$waktu_transaksi"; ?></small></h1>
    </div>
    <div class="row">
        <?php 
            //tampilkan barang
    ...
    <center><h2>Total Keseluruhan : Rp. <?php echo number_format($subtotal); ?></h2></center>
        <?php }else{ ?>
            <center><img src="../assets/ico/kosong.png"><h2>Belum Ada Barang</center>
        <?php } ?>
</div>
<div class="register">
        <div class="container">
            <div class="register-home">
                <p>
                    <a href="riwayat.php" class="btn btn-primary btn=lg">Kembali</a>
                </p>
            </div>
        </div>
    </div><br>
